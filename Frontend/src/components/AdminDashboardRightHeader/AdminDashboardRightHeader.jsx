...
const AdminDashboardRightHeader = ({ title, member, gcp, showIcon, fetchData }) =>
{
  ...
  return (
    <div>
      <div className='h-32 w-full flex justify-between items-start p-3 bg-primary -mt-6 sm:gap-7 gap-4'>
        ...
        <div className='h-auto w-auto sm:py-2 py-0 sm:px-6 px-2 rounded-md shadow-xl'>
          <p className='text-white font-semibold'>You are currently logged on as : {adminData?.email}</p>
        </div>
