                        ...
                        },
{
       ...
       {/* Addcountry component with handleShowCreatePopup prop */}
             {isCreatePopupVisible && (
                    <Addcountry isVisible={isCreatePopupVisible} setVisibility={setCreatePopupVisibility} refreshBrandData={refreshcitiesData}/>
                  )}
{/* Updatecountry component with handleShowUpdatePopup prop */}
                  {isUpdatePopupVisible && (
                    <Updatecountry isVisible={isUpdatePopupVisible} setVisibility={setUpdatePopupVisibility} refreshBrandData={refreshcitiesData}/>
                  )}
