    ...
    <div>
      <div className={`p-0 h-full ${i18n.language === 'ar' ? 'sm:mr-72' : 'sm:ml-72'}`}>
        ...
        {isCreatePopupVisible && (
          <Addcrnumber isVisible={isCreatePopupVisible} setVisibility={setCreatePopupVisibility} refreshBrandData={refreshcitiesData} />
        )}
        {/* Updatecrnumber component with handleShowUpdatePopup prop */}
        {isUpdatePopupVisible && (
          <Updatecrnumber isVisible={isUpdatePopupVisible} setVisibility={setUpdatePopupVisibility} refreshBrandData={refreshcitiesData} />
        )}
