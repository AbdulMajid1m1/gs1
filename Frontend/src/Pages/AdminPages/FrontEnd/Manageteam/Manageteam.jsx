...
import { ManageTeamDataColumn } from '../../../../utils/datatablesource'
...
const Manageteam = () => {
    ...
    const handleAddCompany = async () => {
        ...
        try {
            ...
            toast.success(`Manage Team ${job_title} "${name}" has been added successfully.`, {
                position: "top-right",
                autoClose: 2000,
                hideProgressBar: false,
                closeOnClick: true,
        ...
        if (file) {
            ...
            reader.onload = (e) => {
                ...
                json.forEach((item) => {
                    ...
                    newRequest.post(`/creatour_teams`, formData)
                        .then((res) => {
                            // console.log('Add', res.data);
                            Swal.fire(
                                'Add!',
                                `Manage Team has been created`,
                                'success'
                            )
                            refreshcitiesData()
                        })
                        .catch((err) => {
                            ...
                            Swal.fire(
                                'Error!',
                                `Some Manage Team already exist`,
                                'error'
                            )
                            // Handle errors
                        });
