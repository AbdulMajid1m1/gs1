...
import { UserGuideVideoDataColumn } from '../../../../../utils/datatablesource'
...
const Userguideveido = () => {
    ...
    const handleShowUpdatePopup = (row) => {
        ...
        sessionStorage.setItem("updateUserGuidevideo", JSON.stringify(row));
    };
    ...
    const handleAddCompany = async () => {
        ...
        try {
            ...
            toast.success(`User Guide Video ${job_title} "${name}" has been added successfully.`, {
                position: "top-right",
                autoClose: 2000,
                hideProgressBar: false,
                closeOnClick: true,
        ...
        <div>
            ...
            <div style={{ marginLeft: '-11px', marginRight: '-11px' }}>
                ...
                {isCreatePopupVisible && (
                    <Addvideo isVisible={isCreatePopupVisible} setVisibility={setCreatePopupVisibility} refreshBrandData={refreshcitiesData} />
                )}
                {isUpdatePopupVisible && (
                    <Updatevideo isVisible={isUpdatePopupVisible} setVisibility={setUpdatePopupVisibility} refreshBrandData={refreshcitiesData} />
                )}
            </div>
        </div>
    )
