...
const Blogcategories = () => {
    ...
    const handleDelete = async (row) => {
        Swal.fire({
            ...
            text: `${t('You will not be able to recover this')} ${t('Blog Categories')}!`,
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    if (isDeleted) {
                        toast.success(`${t('Blog Categories')}  ${t('has been deleted')} ${t('successfully')}!`, {
                            position: "top-right",
                            autoClose: 2000,
                    ...
                    toast.error(`${t('Blog Categories')} ${t('has been not deleted')} ${t('Delete')}!`, {
                        position: "top-right",
                        autoClose: 2000,
                        hideProgressBar: false,
                        closeOnClick: true,
                    ...
                    <div className="h-auto w-[97%] px-0 pt-4">
                        <div className="h-auto w-full p-0 bg-white shadow-xl rounded-md">
                            ...
                            <div style={{ marginLeft: '-11px', marginRight: '-11px' }}>
                                ...
                                <DataTable data={data}
                                    title={`${t('Blog Categories')}`}
                                    columnsName={BlogCategoriesDataColumn(t)}
                                    loading={isLoading}
