...
import AddotherProducts from './AddOtherProducts';
import UpdateOtherProducts from './UpdateOtherProducts';
    ...
    <div>
      <div className={`p-0 h-full ${i18n.language === 'ar' ? 'sm:mr-72' : 'sm:ml-72'}`}>
        ...
        {isCreatePopupVisible && (
          <AddotherProducts isVisible={isCreatePopupVisible} setVisibility={setCreatePopupVisibility} refreshBrandData={fetchData} />
        )}
        {/* Updateotherproduct component with handleShowUpdatePopup prop */}
        {isUpdatePopupVisible && (
          <UpdateOtherProducts isVisible={isUpdatePopupVisible} setVisibility={setUpdatePopupVisibility} refreshBrandData={fetchData} />
        )}
