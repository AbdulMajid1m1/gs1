...
const UpdateCategories = ({ isVisible, setVisibility, refreshCategories }) =>
{
          ...
          <div className="popup-container h-auto sm:w-[45%] w-full">
            <div className="popup-form w-full">
              <form onSubmit={handleAddCompany} className='w-full'>
                <h2 className='text-secondary font-sans font-semibold text-2xl'>Update Products Categories</h2>
