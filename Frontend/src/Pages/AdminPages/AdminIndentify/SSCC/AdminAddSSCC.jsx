  ...
  return (
    <div>
      ...
      <div className={`p-0 h-full ${i18n.language === 'ar' ? 'sm:mr-72' : 'sm:ml-72'}`}>
        <div>
          <AdminDashboardRightHeader title={`${t('Add SSCC')}`} />
        </div>
        ...
        <div className="flex flex-col justify-center items-center p-4">
          ...
          <div className="h-auto w-full p-5 bg-white">
            ...
            <div className={`flex ${i18n.language === 'ar' ? 'flex-row-reverse justify-start' : 'flex-row justify-start'}`}>
              <button onClick={() => navigate(-1)} className="rounded-full bg-[#1E3B8B] font-body px-8 py-1 text-sm mb-3 text-white transition duration-200 hover:bg-primary">
                {i18n.language === 'ar' ? (
                  <>
