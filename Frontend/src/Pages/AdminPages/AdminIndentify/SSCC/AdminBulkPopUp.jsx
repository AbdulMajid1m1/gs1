...
const AdminBulkPopUp = ({ isVisible, setVisibility, refreshSsccData }) => {
...
const handleSubmit = async (e) => {
    ...
    try {
      const requestBody = {
        ...
        quantity: quantity,
        user_id: SelectedData?.user_id // Replace with currentUser?.user?.id if needed
      };
                      ...
                      <div className="popup-container h-auto sm:w-[45%] w-full">
                        <div className="popup-form w-full">         
                           <form onSubmit={handleSubmit} className='w-full'>
                             <h2 className='text-secondary font-sans font-semibold text-2xl'>Generate Bulk SSCC Barcodes</h2>
                             <div className="flex flex-col sm:gap-3 gap-3 mt-5">
                               <div className="w-full font-body sm:text-base text-sm flex flex-col gap-2">
                                 <label htmlFor="field1" className="text-secondary">Extension Digit <span className='text-red-600'>*</span></label>
                                 <select 
                               ...
                               <div className="w-full font-body sm:text-base text-sm flex flex-col gap-2">
                                 <label htmlFor="field2" className="text-secondary">Quantity <span className='text-red-600'>*</span> </label>
                                 <input
                                   type="number"
                                   id="field2"
                                   value={quantity}
