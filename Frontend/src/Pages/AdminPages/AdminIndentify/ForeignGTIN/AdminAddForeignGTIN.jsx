...
const AdminAddForeignGTIN = () => {
  ...
  return (
    <>
      <div
        className={`p-0 h-full bg-slate-100 ${i18n.language === "ar" ? "sm:mr-72" : "sm:ml-72"
          }`}
      >
        <div>
        ...
        <div className="flex flex-col justify-center items-center p-4">
          ...
          <div className="h-auto w-full p-5 bg-white">
            <div className="">
              <div
                className={`w-full font-body p-6 shadow-xl rounded-md text-black bg-[#C3E2DC] text-xl mb:2 md:mb-5 ${i18n.language === "ar" ? "text-end" : "text-start"
                  }`}
              >
            ...
            <form onSubmit={handleUserSearch}>
              ...
              <div className="grid 2xl:grid-cols-5 xl:grid-cols-5 lg:grid-cols-5 md:grid-cols-2 grid-cols-1 gap-5 mt-6">
                ...
                <button
                  className={`p-4 rounded truncate ${activeTab === "company-information"
                      ? "bg-primary text-white"
                      : "bg-white text-primary"
                    } shadow-md flex items-center justify-center`}
                ...
                <button
                  className={`p-4 rounded ${activeTab === "digital-link"
                      ? "bg-primary text-white"
                      : "bg-white text-primary"
                    } shadow-md flex items-center justify-center`}
                ...
                <button
                  className={`p-4 rounded ${activeTab === "Miscellaneous"
                      ? "bg-primary text-white"
                      : "bg-white text-primary"
                    } shadow-md flex items-center justify-center`}
