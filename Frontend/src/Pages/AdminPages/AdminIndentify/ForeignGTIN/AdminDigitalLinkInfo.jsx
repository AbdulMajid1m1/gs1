...
import "./AdminDigitalUrlInfo.css";
...
import AdminFormDataPopup from "./AdminFormDataPopup";

const AdminDigitalLinkInfo = () => {
    ...
    <div>
      ...
      <div className={`p-0 h-full bg-slate-100 ${i18n.language === 'ar' ? 'sm:mr-72' : 'sm:ml-72'}`}>
        ...
        <AdminFormDataPopup
          ...
          companyId={selectedGtinData?.companyId}
        />
...
export default AdminDigitalLinkInfo;
