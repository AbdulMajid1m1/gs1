...
const AdminFormDataPopup = ({ data, showPopup, togglePopup, barcode, companyId }) => {
          ...
          <div className="digital-popup-form">
            <form onSubmit={handleSubmit} id="gtin-form" name="gtin-form">
              ...
              <div className="popup-footer">
                ...
                <Button
                  variant="contained"
                  style={{ backgroundColor: '#021F69', color: '#ffffff', marginLeft: '10px' }}
                  disabled={isLoading}
                  type="submit"
...
export default AdminFormDataPopup;
