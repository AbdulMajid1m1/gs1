                ...
                <div className="flex flex-col justify-center items-center p-4">
                    ...
                    <div className="h-auto w-full p-5 bg-white">
                        <div className="">
                            <div className={`w-full font-body p-6 shadow-xl rounded-md text-black bg-[#C3E2DC] text-xl mb:2 md:mb-5 ${i18n.language === 'ar' ? 'text-end' : 'text-start'}`}>
                                <div className="flex justify-start flex-col gap-2 text-xs sm:text-sm">
                                    ...
                                    <p>
                                        {t('This number is registered to company')}: :{" "}   {/* <span className="font-semibold">{currentUser?.user?.company_name_eng}</span> */}
                        ...
                        <button type='submit' className="popup-save" id="gtin-form">Add</button> */}
                                    <button onClick={() => navigate(-1)} className="popup-close bg-secondary">{t('Back')}</button>
                                    <button onClick={handleFormSubmit} className="popup-save" id="gtin-form"> {t('Add')}</button>
                                </div>
                            </div>
                        </form>
