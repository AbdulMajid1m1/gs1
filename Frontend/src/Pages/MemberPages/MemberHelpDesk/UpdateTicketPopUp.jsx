          ...
          <div className="popup-container h-auto sm:w-[45%] w-full">
            <div className="popup-form w-full">
              <form className='w-full'>
                <h2 className={`text-secondary font-sans font-semibold text-2xl ${i18n.language === "ar" ? "text-end" : "text-start"}`}>{t('Update Ticket')}</h2>
                <div className="flex flex-col sm:gap-3 gap-3 mt-1">
                  <div className="w-full font-body sm:text-base text-sm flex flex-col gap-2">
                    <label htmlFor="field1" className={`text-secondary  ${i18n.language === "ar" ? "text-end" : "text-start"}`}>{t('Title')}<span className='text-red-600'> *</span></label>
                    <input
                      type="text"
                      id="field1"
                      value={Title}
                  ...
                  <div className="w-full font-body sm:text-base text-sm flex flex-col gap-2 -mt-3">
                    <label htmlFor="field2" className={`text-secondary  ${i18n.language === "ar" ? "text-end" : "text-start"}`}>{t('Description')}<span className='text-red-600'> *</span> </label>
                    <textarea
                      type="text"
                      id="field2"
                      value={Description}
                ...
                <div className="flex flex-col sm:gap-3 gap-3">
                  <div className="w-full font-body sm:text-base text-sm flex flex-col gap-2">
                    <label htmlFor="field3" className={`text-secondary  ${i18n.language === "ar" ? "text-end" : "text-start"}`}>{t('Documents/Screenshot')}<span className='text-red-600'> *</span></label>
                    <input
                      type="file"
                      id="field3"
                      //  value={Title}
