...
// change the address when user selected on the map
  ...
  return (
    <div>
        ...
        <div>
            <DashboardRightHeader title={"Update GLN"}/>
        </div>
            ...
            {/* <div className='h-auto w-full p-6 shadow-xl'> */}
                ...
                <form>
                    <div className="flex flex-col sm:gap-8 gap-3 sm:flex-row sm:justify-between mt-4">
                        ...
                        <div className="w-full font-body sm:text-base text-sm flex flex-col gap-0">
                            <label htmlFor='locationArabic' className='text-secondary'>Location Name [Arabic]<span className='text-red-600'>*</span></label>
                            <input
