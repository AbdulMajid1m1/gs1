        ...
        <div className="header-item item-center">
          ...
          <nav className={`menu ${isMobileMenuOpen ? 'active' : ''}`} style={{ backgroundColor: 'white' }}>
            <div className="mobile-menu-head">
              ...
              <ul className={`menu-main ${i18n.language === 'ar' ? 'flex-row-reverse' : 'flex-row'} 2xl:flex xl:flex lg:flex 3xl:flex 3xl:justify-center 3xl:items-center 2xl:justify-center xl:justify-center lg:justify-center 2xl:items-center xl:items-center lg:items-center sm:gap-5`}>
