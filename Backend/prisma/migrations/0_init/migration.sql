...
CREATE TABLE [dbo].[users_temp] (
    ...
    [location_uk] NVARCHAR(max),
    [have_cr] NVARCHAR(max),
    [cr_documentID] INT CONSTRAINT [users_temp_cr_documentID_df] DEFAULT 0,
    [document_number] NVARCHAR(max),
    [fname] NVARCHAR(max),
    [lname] NVARCHAR(max),
    [email] NVARCHAR(max),
    ...
    [invoice_file] NVARCHAR(max),
    [otp_status] INT,
    [createdAt] DATETIME2 NOT NULL CONSTRAINT [users_temp_createdAt_df] DEFAULT CURRENT_TIMESTAMP,
    ...
    [user_id] NVARCHAR(max),
    [remarks] NVARCHAR(max),
    [assign_to] INT CONSTRAINT [DF_users_temp_assign_to] DEFAULT 0,
    [membership_category] NVARCHAR(50),
    [upgradation_disc] INT CONSTRAINT [DF_users_temp_upgradation_disc] DEFAULT 0,
    [upgradation_disc_amount] FLOAT(53) CONSTRAINT [DF_users_temp_upgradation_disc_amount] DEFAULT 0,
    [renewal_disc] INT CONSTRAINT [DF_users_temp_renewal_disc] DEFAULT 0,
    [renewal_disc_amount] FLOAT(53) CONSTRAINT [DF_users_temp_renewal_disc_amount] DEFAULT 0,
    [membership_otherCategory] NVARCHAR(50),
    [activityID] INT CONSTRAINT [DF_users_temp_activityID] DEFAULT 0,
    [registration_type] NCHAR(10),
    CONSTRAINT [users_temp_pkey] PRIMARY KEY CLUSTERED ([id])
);
